...
--
-- NOTA: el username en USUARIO.USUARIO puede estar en minusculas
-- (confirmado: SMORAN esta guardado como 'smoran'). Estas consultas
-- usan UPPER() para que no dependan de como este escrito.
-- =====================================================================
...
INSERT INTO APP_USUARIO_PERMISO (IDUSUARIO, ID_PERMISO, TIPO)
    SELECT IDUSUARIO, 3, 'D' FROM USUARIO WHERE UPPER(USUARIO) = 'GNARANJO';
INSERT INTO APP_USUARIO_PERMISO (IDUSUARIO, ID_PERMISO, TIPO)
    SELECT IDUSUARIO, 5, 'D' FROM USUARIO WHERE UPPER(USUARIO) = 'GNARANJO';
INSERT INTO APP_USUARIO_PERMISO (IDUSUARIO, ID_PERMISO, TIPO)
    SELECT IDUSUARIO, 6, 'D' FROM USUARIO WHERE UPPER(USUARIO) = 'GNARANJO';

-- Dársela a SMORAN (conceder aunque su cargo no la incluya)
-- Ya aplicado directamente por IDUSUARIO=162 el 2026-07-08 (ver
-- 004_smoran_inventario_full.sql); estas lineas quedan solo de referencia.
INSERT INTO APP_USUARIO_PERMISO (IDUSUARIO, ID_PERMISO, TIPO)
