...
String compania = (String) session.getAttribute("compania");
    ...
    if(session.getAttribute("usuario")==null){
             ...
             if(cargo.equals("ADMINISTRADOR")||apellidos.equals("Varas Herrera")||cargo.equals("JEFE")){
                }else{
                    response.sendRedirect("../sesionInvalida.jsp");
             }
%>
                                    ...
                                    <div class="col-md-4">
                                        <a href="../Inventario/INV_Equipos_Asignados.jsp">
                                            <div class="card">
                                                <div class="card-header mx-4 p-3 text-center">
                                                    <div class="icon icon-shape icon-lg bg-gradient-primary shadow text-center border-radius-lg">
                                                        <i class="ni ni-active-40 opacity-10"></i>
                                                        <!--<i class="fa fa-users text-lg opacity-10" aria-hidden="true"></i>-->
                                                    </div>
                                                </div>
                                                <div class="card-body pt-0 p-3 text-center">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card mb-4">
                            ...
                            <div>
                                <!--<h2 class="mb-4">Export Table to Excel and PDF</h2>-->
                                <!-- Botones para descargar en Excel y PDF -->
                                <!--        <button id="exportExcel" class="btn btn-success mb-2">Download as Excel</button>
                                        <button id="exportPDF" class="btn btn-danger mb-2">Download as PDF</button>-->
                                <!--        <script>
                                    ...
                                    <table id= "example" class="table align-items-center mb-0 table-striped table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Fecha Compra</th>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Caracteristicas</th>
                     ...
                     //                            String sql = "select a.IDUSUARIO, a.NOMBRE, a.APELLIDOS, a.EMAIL, b.COMPANIA  , c.departamento from USUARIO a, compania b, adm_departamento c where a.IDCOMPANIA = b.IDCOMPANIA AND a.ESTADO = 'a' AND a.id_adm_departamento =c.id_departamento order by 1";
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"> <%=idEquipoNew = rs.getString(1)%></p>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><%=rs.getString(2)%></p>
                                                    <p class="text-xs font-weight-bold mb-0">Currier: <%=rs.getString(20)%></p>
                                                </td>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"> <%=idEquipoNew = rs.getString(21)%></p>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm"> <%=rs.getString(16)%> </h6>
                                                             <!--<h6 class="mb-0 text-sm">Apellidos  <%=rs.getString(6)%></h6>-->
                                                            <p class="text-xs text-secondary mb-0"><%=rs.getString(18)%></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">Marca: <%=rs.getString(5)%> </h6>
                                                            <h6 class="mb-0 text-sm">Modelo:  <%=rs.getString(6)%></h6>
                                                            <p class="text-xs text-secondary mb-0">S/N:  <%=rs.getString(7)%></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            <h6 class="mb-0 text-sm">Procesador: <%=rs.getString(8)%> </h6>
                                                            <h6 class="mb-0 text-sm">HDD:  <%=rs.getString(10)%></h6>
                                                            <h6 class="mb-0 text-sm">RAM:  <%=rs.getString(11)%></h6>
                                                            <p class="text-xs text-secondary mb-0">Pantalla  <%=rs.getString(12)%></p>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <%if(rs.getString(14).equals("A")){%>
                                                    <!--<p class="text-xs font-weight-bold mb-0" title="Asignado." style="background-color: yellow">Asignado</p>-->
                                                    ...
                                                    <%}%>
                                            <!--                        <p class="text-xs font-weight-bold mb-0"><%=rs.getString(14)%></p>
                                                    ...
                                                    <div class="d-flex flex-column justify-content-center" style="width: 100%;">
                                                        ...
                                                        <div class="text-center">
                                                            <img src="../INV_MostrarImagenEquipo?nombre=equipo_<%=rs.getString(1)%>"
                                                                 ...
                                                                 data-bs-target="#modalImagenEquipo_<%=rs.getString(1)%>" />
                                                        </div>
                                                ...
                                                <td class="align-middle text-center text-sm">
                                                    ...
                                                    if(departamento.equals("Contabilidad"))
                                                    {
                                                    %>

                                                    <span class="badge badge-sm bg-gradient-success">CONTABILIDAD</span>
                                                    <%  }%>

                                                    <%if(departamento.equals("Norte"))
                                                    {
                                                    %>
                                                    <span class="badge badge-sm bg-gradient-success">CONTABILIDAD</span>
                                                    <%  }%>

                                                    <% if(departamento.equals("MARKETING"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-warning">MARKETING</span>
                                                    <%}%>

                                                    <% if(departamento.equals("Tecnología"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-dark">TECNOLOGÍA</span>
                                                    <%}%>

                                                    <% if(departamento.equals("Legal"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-primary">LEGAL</span>
                                                    <%}%>

                                                    <% if(departamento.equals("Impuestos"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-danger">IMPUESTOS</span>
                                                    <%}%>

                                                    <% if(departamento.equals("ADMINISTRACIÓN"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-secondary">ADMINISTRACIÓN</span>
                                                    <%}%>

                                                    <% if(departamento.equals("Auditoría"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-warning">AUDITORÍA</span>
                                                    <%}%>

                                                    <% if(departamento.equals("OUTSOURCING"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-warning-vertical">OUTSOURCING</span>
                                                    <%}%>

                                                    <% if(departamento.equals("ADMINISTRACIÓN NORTE"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-info-vertical">ADMINISTRACIÓN NORTE</span>
                                                    <%}%>

                                                    <% if(departamento.equals("IMPUESTOS NORTE"))
                  {%>
                                                    <span class="badge badge-sm bg-gradient-faded-primary-vertical">IMPUESTOS NORTE</span>
                                                    <%}%>
                                                ...
                                                <!--                      <td class="align-middle">
                                                               ...
                                                               <i class="material-icons fas fa-eye " style="color:white;font-size:25px"></i>
                                                ...
                                                <td class="w-30">
                                                    <div class="d-flex px-2 py-1 align-items-center">
                                                        <div>
                                                            <a class="btn btn-xs btn-primary " href="../Inventario/INV_Equipos_Editar.jsp?idInvEquipo=<%=rs.getString(1)%>">
                                                                <i class="fas fa-pencil-alt">Editar / Asignar</i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </td>
                                                <!--                    <td class="w-30">
                                                                      <div class="d-flex px-2 py-1 align-items-center"data-bs-toggle="modal" data-bs-target="#asignarEquipoUsuario" onclick="passIdToModal('<%= rs.getString(1) %>')" >
                                                                        <div>
