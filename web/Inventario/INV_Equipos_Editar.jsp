...
+ " Not IDUSUARIO In (select a.IDUSUARIO from INV_ASIGNACION a where a.ESTADO = 'A')  order by 2";
    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header pb-0">
                <h6>Imagen del equipo</h6>
            </div>
            <div class="card-body px-4 pt-3 pb-4">
                <form action="../INV_Subir_Imagen_Equipo" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="equipoId" value="<%=idInvEquipo%>" readonly />
