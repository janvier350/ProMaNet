...
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.15/css/dataTables.bootstrap.min.css">
 ...
 if(COMUN.PermisoHelper.tiene(session, "TALENTO_HUMANO_SUMINISTROS_ACCESO")){%>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="../Inventario/INV_Lista_Productos.jsp">
                            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                                <i class="ni ni-user-run text-bg-light text-sm opacity-10"></i>
                            </div>
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Inventarios</a></li>
                ...
                <table id= "example" class="table align-items-center mb-0 table-striped table-hover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Existencia</th>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">medida</th>
                       <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Detalle medida</th>
                  ...
                  <tbody>
                       <% 
                        try{
                            ...
                            String sql = "    SELECT p.ID_PRODUCTO,p.DESCRIPCION AS PRODUCTO,c.DESCRIPCION AS CATEGORIA,u.UNIDAD AS MEDIDA, u.DESCRIPCION AS DETALLE_MEDIDA, c.ESTADO AS ESTADO_CATEGORIA FROM INV_PRODUCTO p INNER JOIN INV_CATEGORIA c ON p.INV_ID_CATEGORIA = c.INV_ID_CATEGORIA INNER JOIN INV_UNIDAD_MEDIDA u ON p.ID_UNIDAD = u.ID_UNIDAD_MEDIDA ORDER BY p.ID_PRODUCTO DESC";
                      ...
                      <td class="align-middle">
                        <button class="btn btn-link text-secondary mb-0">
                          <i class="fa fa-ellipsis-v text-xs"><%=rs.getString(5)%></i>
                        </button>
                      </td>
