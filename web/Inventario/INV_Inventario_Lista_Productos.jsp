    ...
    <head>
        ...
        <script>
            function enviarSolicitud() {
                ...
                xhr.open("GET", "../INV_MensajeServlet", true);
                ...
                xhr.onload = function () {
                    if (xhr.status === 200) {
                        ...
                        console.log("saludos desde el script");
                    } else {
        ...
        <script>
            ...
            function cargarProductos() {
                const xhr = new XMLHttpRequest();
                xhr.open("GET", "ProductoServlet", true);
                xhr.onload = function () {
                    if (xhr.status === 200) {
                        const productos = JSON.parse(xhr.responseText);
                        console.log("Lista de productos:", productos); // Mostrar los productos en la consola
            ...
            function agregarProducto() {
                ...
                const xhr = new XMLHttpRequest();
                xhr.open("POST", "AgregarProductoServlet", true);
                xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                xhr.onload = function () {
                    if (xhr.status === 200) {
                        cargarProductos(); // Actualizar la tabla después de agregar
                        document.getElementById("nombreProducto").value = ""; // Limpiar el input
                    }
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" value="<%=idUsuari%>">
                                            </div>
                                            <h1>Ejemplo Básico de Ajax</h1>
                                            <button onclick="enviarSolicitud()">Enviar Solicitud</button>
                                            <p id="respuesta">Aquí aparecerá la respuesta del servidor</p>
                                            Saludos ecuador
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <p>Fecha y hora del servidor: <%= new java.util.Date() %></p>    

                                                <h1>Lista de Productos otro</h1>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Fecha de compra</th>
                                        ...
                                        <tbody >
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0"><%= rs3.getString(1) %></p>
                                                ...
                                                <td>
                                                    <div class="d-flex px-2 py-1">
                                                        ...
                                                        <div class="d-flex flex-column justify-content-center">
                                                            ...
                                                            <p class="text-xs text-secondary mb-0"> <%= rs3.getString(10) %></p>
                                                        </div>
                                                    </div>
                                                </td>

                                                <%
                                                    if(rs3.getString(7).equals("D")){%>
                                                <td class="align-middle text-center">
                                                     <!--<p class="text-xs font-weight-bold mb-0"><%= rs3.getString(7) %></p>-->
                                                    <p class="text-xs text-secondary mb-0">Disponible</p>
                                                </td>
                                                <%} %>
                                                <%
                                                    if(rs3.getString(7).equals("V")){%>
                                                <td class="align-middle text-center">
                                                     <!--<p class="text-xs font-weight-bold mb-0"><%= rs3.getString(7) %></p>-->
                                                    <p class="text-xs text-secondary mb-0">Vendida</p>
                                                </td>
                                                <%} %>
                                                <%
                                                    if(rs3.getString(7).equals("I")){%>
                                                <td class="align-middle text-center">
                                                     <!--<p class="text-xs font-weight-bold mb-0"><%= rs3.getString(7) %></p>-->
                                                    <p class="text-xs text-secondary mb-0">Infraestructura</p>
                                                </td>
                                                <%} %>
                                                <%
                                                    if(rs3.getString(7).equals("F")){%>
                                                <td class="align-middle text-center">
                                                     <!--<p class="text-xs font-weight-bold mb-0"><%= rs3.getString(7) %></p>-->
                                                    <p class="text-xs text-secondary mb-0 text-danger">Fuera de servicio</p>
                                                </td>
                                                <%} %>
                                                <%
                                                    if(rs3.getString(7).equals("A")){%>
                                                <td class="align-middle text-center">
                                                     <!--<p class="text-xs font-weight-bold mb-0"><%= rs3.getString(7) %></p>-->
                                                    <p class="text-xs text-secondary mb-0 ">Asignado</p>
                                                </td>
                                                <%} %>

                                                <%
                                                    if(rs3.getString(7).equals("R")){%>
                                                <td class="align-middle text-center">
                                                     <!--<p class="text-xs font-weight-bold mb-0"><%= rs3.getString(7) %></p>-->
                                                    <p class="text-xs text-secondary mb-0"><strong>Robado</strong></p>
                                                </td>
                                                <%} %>

                                                <%
                                                    if(rs3.getString(7).equals("M")){%>
                                                <td class="align-middle text-center">
                                                     <!--<p class="text-xs font-weight-bold mb-0"><%= rs3.getString(7) %></p>-->
                                                    <p class="text-xs text-secondary mb-0 text-warning">Mantenimiento</p>
                                                </td>
                                                <%} %>
                                                ...
                                                <td class="align-middle text-center">
                                                    <p><span class="text-secondary text-xs font-weight-bold mb-0"><%= rs3.getString(11) %></span></p>
                                                </td>
                                                <td class="align-middle">
                                                    <p><span class="text-secondary text-xs font-weight-bold mb-0"><%= rs3.getString(12) %></span></p>
                                                </td>
                                                <td class="align-middle">
                                                    <p><span class="text-secondary text-xs font-weight-bold mb-0"><%= rs3.getString(13) %></span></p>
                                                </td>
                                                <td class="text-wrap">
                                                    <p><span class="text-secondary text-xs font-weight-bold mb-0"><%= rs3.getString(14) %></span></p>
