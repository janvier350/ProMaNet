...
<html>
    <head>
        ...
        <title>
            ProMaNet | Ingreso Suministros Marketing
        </title>
        <!--     Fonts and icons     -->
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder text-white mb-0">Ingreso de suministros Marketing</h6>
                    </nav>
                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body pb-3">
                                    <form role="form text-left" action="../INV_InsertProducto">
                                        ...
                                        DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
                                        Connection   cn = DriverManager.getConnection(url, user, pass);
                                        String sql = "select * from INV_UNIDAD_NEGOCIO order by 2";
                                        PreparedStatement st = cn.prepareStatement(sql);
                                        ResultSet rs = st.executeQuery();       
                                        while (rs.next()) {%>        
                                                    <option value="<%=rs.getString(1)%>"><%=rs.getString(2)%> </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <label for="example-text-input" class="form-control-label"> </label>
                                            <button type="#" class="btn btn-warning"  href=""  data-bs-toggle="modal" data-bs-target="#exampleModalSignProveedor">   Nuevo proveedor</button>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label"> </label>
                                            <label for="example-text-input" class="form-control-label"> </label>
                                            <button type="#" class="btn btn-warning"  href=""  data-bs-toggle="modal" data-bs-target="#exampleModalSignUpUnidades">   Nuevo Unidad de medida</button>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label"></label>
                                            <label for="example-text-input" class="form-control-label">  </label>
                                            <button type="#" class="btn btn-warning"  href=""  data-bs-toggle="modal" data-bs-target="#exampleModalSignUp2">   Nuevo Categoría</button>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label"></label>
                                            <label for="example-text-input" class="form-control-label">  </label>
                                            <button type="#" class="btn btn-warning"  href=""  data-bs-toggle="modal" data-bs-target="#exampleModalSignUp">   Nuevo Producto</button>
                                            <!--<input class="form-control" type="date" name ="fechaRecibido">-->
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    <td>
                                                        <span class="text-xs font-weight-bold"><%= rs.getString(8)%></span>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <!--<a class="btn btn-xs btn-success "data-bs-toggle="tooltip" title="Modificar o agregar comentario a esta tarea!" href="INV_Ingreso_Suministro_Detalle.jsp?ID_SUMINISTRO_INGRESO_CAB=<%=rs.getString(1)%>"> <i class="fas fa-pencil-alt"></i></a>-->
                                                                                                        </td>
                                                    ...
                                                    <!--                                                
                                                                                                    <td class="align-middle">
                                                                                                        <button class="btn btn-link text-secondary mb-0">
                                                                                                            <i class="fa fa-ellipsis-v text-xs">algo</i>
                                                                                                        </button>
                                                                                                    </td>-->
                                                </tr>
                                                <!--                    <tr>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h3 class="font-weight-bolder text-primary text-gradient">Productos</h3>
                        <input type="hidden" value="<%=id_suministro_ingreso_cab%>"> <!-- Usar hidden para valores no visibles -->
                        <input type="text" value="<%=id_suministro_ingreso_cab%>"> 
                    </div>
                    <div class="card-body pb-3">
                        <table id="detalles" class="table table-striped table-hover">
                            <thead class="">
                            ...
                            <tbody align="center">
                                ...
                                try {
                                    ...
                                    String sql2 = "SELECT * FROM INV_SUMINISTRO_INGRESO_DET WHERE ID_SUMINISTRO_INGRESO_CAB = ?";
                                    PreparedStatement st2 = cn2.prepareStatement(sql2);
                                    st2.setInt(1, Integer.parseInt(id_suministro_ingreso_cab)); // Asignar el valor del parámetro
                                    ResultSet rs2 = st2.executeQuery();
                                ...
                                %>
                                <tr>
                                    <td><%= rs2.getString("ID_PRODUCTO") %></td> <!-- Ajusta el nombre de la columna -->
                                    <td><%= rs2.getString("CANTIDAD") %></td> <!-- Ajusta el nombre de la columna -->
                                    <td><%= rs2.getString("ID_SUMINISTRO_INGRESO_CAB") %></td> <!-- Ajusta el nombre de la columna -->
                                  
                                </tr>
                                <%
                                    }
System.out.println("Consulta SQL: " + sql2);
System.out.println("ID Suministro Ingreso Cab: " + id_suministro_ingreso_cab);
                                    // Cerrar recursos
                                    rs2.close();
                                    st2.close();
                                    cn2.close();
