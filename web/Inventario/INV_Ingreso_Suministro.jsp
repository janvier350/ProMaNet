    ...
    function agregarProducto() {
        ...
        if (producto && cantidadNumerica > 0) {
            ...
            $.ajax({
                url: 'CompraServlet',
                method: 'POST',
                data: {action: 'agregar', producto: producto, cantidad: cantidadNumerica},
                success: function (response) {
                    $('#tablaProductos tbody').html(response); // Actualiza la tabla
                    $('#producto').val(''); // Limpia el campo de producto
                    $('#cantidad').val(''); // Limpia el campo de cantidad
                },
                error: function (xhr, status, error) {
                    console.error("Error en la llamada AJAX:", status, error);
                    console.log("Detalles del error:", xhr.responseText); // Inspecciona el mensaje de error
                }
            });
        } else {
                                    ...
                                    <div class="row">
                                        ...
                                        <div>
                                            <button type="#" class="btn btn-warning"  href="">
                                                <a class="nav-link " href="../Inventario/Ingreso_Suministro.jsp"> <i class="fa fa-pencil-alt" aria-hidden="true">  </i>Ingreso de suministos </a>
                                            </button>
                                        </div>
                                        <div>
                        ...
                        <div class="card ">
                            ...
                            <div class="table-responsive overflow-auto" style="max-height: 400px;">
                                ...
                                <form action="../CompraServlet" method="post">
                                    ...
                                    <table id="tablaProductos"  name="tablaProductos" border="1">
                                        <thead>
                                            <tr>
                                                <th>Producto</th>
                                                <th>Cantidad</th>
