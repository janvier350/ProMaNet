        ...
        <main class="main-content position-relative border-radius-lg ">
            ...
            <div class="container-fluid py-4">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-2 col-sm-6 mb-xl-0 mb-4">
                        <div class="card">
                            <a href="../Inventario/INV_Lista_Productos.jsp">
                                <div class="card-body p-3">
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                <p class="text-sm mb-0 text-uppercase font-weight-bold">Lista de </p>
                                                <h5 class="font-weight-bolder">
                                                    PRODUCTOS
                                                </h5>
                                                <p class="mb-0">
                                    ...
                                    <div class="row">
                                        <div class="col-8">
                                            <div class="numbers">
                                                ...
                                                <p class="mb-0">
                                                    <span class="text-primary text-sm font-weight-bolder">Consute </span>
                                                    <b class="text-primary">existencia</b>
                                                </p>
                                            </div>
                                        </div>
                                        <div class="col-4 text-end">
