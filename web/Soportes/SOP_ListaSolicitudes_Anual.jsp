...
String compania = (String) session.getAttribute("compania");
    ...
    int totalHoy = 0, totalSemana = 0, totalMes = 0, totalAnio = 0;
    try {
        ...
        String sqlStats = "SELECT " +
                          "COUNT(CASE WHEN TRUNC(fecha_solicitud) = TRUNC(SYSDATE) THEN 1 END), " +
                          "COUNT(CASE WHEN TRUNC(fecha_solicitud) >= TRUNC(SYSDATE, 'IW') THEN 1 END), " +
                          "COUNT(CASE WHEN TRUNC(fecha_solicitud) >= TRUNC(SYSDATE, 'MM') THEN 1 END), " +
                          "COUNT(*) " +
                          "FROM sop_soporte_cab WHERE estado = 'ATENDIDO' AND fecha_solicitud >= TRUNC(SYSDATE, 'YYYY')";
        
        PreparedStatement psStat = cna5.prepareStatement(sqlStats);
        ResultSet rsStat = psStat.executeQuery();
        if(rsStat.next()){
            totalHoy = rsStat.getInt(1);
            totalSemana = rsStat.getInt(2);
            totalMes = rsStat.getInt(3);
            totalAnio = rsStat.getInt(4);
        }
        rsStat.close();
        psStat.close();
...
<!--            <a class="nav-link " href="../cerrar.jsp">
  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Tickets</a></li>
    ...
    <div class="container-fluid py-4">
       <span class="d-sm-inline d-none"> 
           <b class="text-white"> ATENDIDOS </b>  </span>
        <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> HOY</p>
                                            <h5 class="font-weight-bolder">
                                              <%=totalHoy%>
                                            </h5>
                                            <p class="mb-0">
                                                <span class="text-success text-sm font-weight-bolder">Atendidos hoy</span>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> ESTA SEMANA</p>
                                            <h5 class="font-weight-bolder">
                                               <%=totalSemana%>
                                            </h5>
                                            <p class="mb-0">
                                                <span class="text-success text-sm font-weight-bolder"></span>
                                                Atendidos durante la semana
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">ESTE MES</p>
                                            <h5 class="font-weight-bolder">
                                              <%=totalMes%>
                                            </h5>
                                            <p class="mb-0">
                                                <span class="text-danger text-sm font-weight-bolder"></span>
                                               Tickets generados este mes
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">ESTE AÑO</p>
                                            <h5 class="font-weight-bolder">
                                               <%=totalAnio%>
                                            </h5>
                                            <p class="mb-0">
                                                <span class="text-success text-sm font-weight-bolder">Atendidos en el año</span> 
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-4 text-end">
