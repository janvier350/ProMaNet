...
String compania = (String) session.getAttribute("compania");
    ...
    String depart = "";
    String total_equipos = "";
    String total_disponibles = "";
    String total_infraestructura = "";
    String total_equipos_2025 = "";
    String total_compras_equipos_en_curso = "";
    String total_impresoras = "";
    String total_equipos_2024 = "";
    String total_equipos_2023 = "";
 ...
 try{
        ...
        String contar_equipos  = "SELECT COUNT(*) AS TOTAL_ASIGNADOS FROM INV_EQUIPOS WHERE ESTADO = 'A'and estado_ai = 'A'";

        PreparedStatement st4 = cn4.prepareStatement(contar_equipos);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_equipos = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
 ...
 try{
        ...
        String contar_equipos_disponibles  = "SELECT COUNT(*) AS TOTAL_DISPONIBLES FROM INV_EQUIPOS WHERE ESTADO = 'D' and estado_ai = 'A'";

        PreparedStatement st4 = cn4.prepareStatement(contar_equipos_disponibles);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_disponibles = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
...
try{
        ...
        String contar_equipos_infraestructura  = "SELECT COUNT(*) AS TOTAL_INFRAESTRUCTURA FROM INV_EQUIPOS WHERE ESTADO = 'I' and estado_ai = 'A'";

        PreparedStatement st4 = cn4.prepareStatement(contar_equipos_infraestructura);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_infraestructura = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
...
try{
        ...
        String compra_ano_actual  = "SELECT COUNT(*) AS TOTAL_ANIO_CURSO FROM INV_EQUIPOS WHERE EXTRACT(YEAR FROM FECHACOMPRA) = EXTRACT(YEAR FROM SYSDATE)";

        PreparedStatement st4 = cn4.prepareStatement(compra_ano_actual);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_compras_equipos_en_curso = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
...
try{
        ...
        String compra_2025  = "SELECT COUNT(*) AS TOTAL_ANIO_PASADO FROM INV_EQUIPOS WHERE EXTRACT(YEAR FROM FECHACOMPRA) = EXTRACT(YEAR FROM SYSDATE) - 1";

        PreparedStatement st4 = cn4.prepareStatement(compra_2025);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_equipos_2025 = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
...
try{
        ...
        String compra_2024  = "SELECT COUNT(*) AS TOTAL_ANIO_PASADO FROM INV_EQUIPOS WHERE EXTRACT(YEAR FROM FECHACOMPRA) = EXTRACT(YEAR FROM SYSDATE) - 2";

        PreparedStatement st4 = cn4.prepareStatement(compra_2024);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_equipos_2024 = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
...
try{
        ...
        String compra_2023  = "SELECT COUNT(*) AS TOTAL_ANIO_PASADO FROM INV_EQUIPOS WHERE EXTRACT(YEAR FROM FECHACOMPRA) = EXTRACT(YEAR FROM SYSDATE) - 3";

        PreparedStatement st4 = cn4.prepareStatement(compra_2023);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_equipos_2023 = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
...
try{
        ...
        String impresoras  = "SELECT COUNT(*) AS total_impresoras_activas FROM inv_equipos WHERE dispositivo = 'Impresora' AND estado_ai = 'A'";

        PreparedStatement st4 = cn4.prepareStatement(impresoras);
        ResultSet rs4 = st4.executeQuery();       
    while (rs4.next()) {
    total_impresoras = rs4.getString(1);
        }
            rs4.close();
            st4.close();
            cn4.close();
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="javascript:;">Soporte Sistemas</a></li>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> Asignados</p>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">INFRAESTRUCTURA</p>
                                            <h5 class="font-weight-bolder">
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">Impresoras</p>
                                            <h5 class="font-weight-bolder">
                                                <%=total_impresoras %>
                                            </h5>
                                            <p class="mb-0">
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> adquiridos 2026</p>
                                            <h5 class="font-weight-bolder">
                                                <%=total_compras_equipos_en_curso%>
                                            </h5>
                                            <p class="mb-0">
                                                <span class="text-success text-sm font-weight-bolder">2025</span>
|
                                            </p>
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> ADQUIRIDOS 2025</p>
                                            <h5 class="font-weight-bolder">
                                                <%=total_equipos_2025%>
                                            </h5>
                                            <p class="mb-0">
                                                <span class="text-success text-sm font-weight-bolder">2026</span>
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> ADQUIRIDOS 2024</p>
                                            <h5 class="font-weight-bolder">
                                                <%=total_equipos_2024 %>
                                            </h5>
                                            <p class="mb-0">
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold"> ADQUIRIDOS 2023</p>
                                            <h5 class="font-weight-bolder">
                                                <%=total_equipos_2023 %>
                                            </h5>
                                            <p class="mb-0">
                              ...
                              <div class="row">
                                <div class="col-8">
                                  <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                      <span class="text-success text-sm font-weight-bolder">Genere </span>
                                       <b class="text-success ">de gastos diarios.</b>
                                    </p>
                                  </div>
                                </div>
                                <div class="col-4 text-end">
                              ...
                              <div class="row">
                                <div class="col-8">
                                  <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                      <span class="text-success text-sm font-weight-bolder">Mejore su productividad</span>
                                      <b class="text-success"> registrando tareas.</b>
                                    </p>
                                  </div>
                                </div>
                                <div class="col-4 text-end">
                ...
                <br>
                  <hr class="horizontal dark">
                        ...
                        <div class="col-xl-2 col-sm-6 mb-xl-0 mb-4">
                          <div class="card">
                              <a href="../Inventario/INV_Inventarios.jsp">
                              <div class="card-body p-3">
                              <div class="row">
                                <div class="col-8">
                                  <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Inventarios </p>
                                    
                                    <h5 class="font-weight-bolder"> Reporte de Inventarios </h5>
                                    <p class="mb-0">
                                      <span class="text-success text-sm font-weight-bolder">Consulte  </span>
                                       <b class="text-success ">Activos de la empresa y su estado.</b>
                                    </p>
                                  </div>
                                </div>
                                <div class="col-4 text-end">
                        ...
                        <div class="col-xl-2 col-sm-6 mb-xl-0 mb-4">
                          <div class="card">
                              <a href="../Soportes/SOP_ListaSolicitudes_Anual.jsp">
                                  <div class="card-body p-3">
                              <div class="row">
                                <div class="col-8">
                                  <div class="numbers">
                                    ...
                                    <p class="mb-0">
                                      <span class="text-success text-sm font-weight-bolder"></span>
                                      <b class="text-success"> vista general de los tickets.</b>
                                    </p>
                                  </div>
                                </div>
                                <div class="col-4 text-end">
                                    ...
                                    <table class="table align-items-center justify-content-center mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <!--          <td>
                                                            <p class="text-sm font-weight-bold mb-0"><%=rsa5.getString(13)%> </p>
                                                          </td>-->
                                            </tr>
                                            <% 
                                                } 
