                        ...
                        <% String sqlAtrasos =""; 
                            ...
                            try{
                              ...
                              Connection cna = DriverManager.getConnection(url, user, pass);               
                                  sqlAtrasos = "select  a.fecha_solicitud, b.marca, b.modelo,b.fechacompra, a.soporte, a.prioridad, a.estado, a.idsoporte from sop_soporte_cab a , inv_equipos b where a.idequipo = b.idinvequipo and a.idusuario =  "+codigo+" and a.estado = 'PENDIENTE' order by 1 desc";
...
<!--                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle">
                        <a href ="../Soportes/SOP_EditarSolicitudes.jsp?idSolicitud=<%= rsa.getString(8)%>&fecha=<%= rsa.getString(1)%>&soporte=<%= rsa.getString(5)%>&prioridad=<%= rsa.getString(6)%>&estado=<%= rsa.getString(7)%>" class="btn btn-sm btn-info mb-0 d-none d-lg-block "> Editar</a>
                      </td>
                      <td class="align-middle">
                  ...
                  <tbody>
                        <% 
                            ...
                            try{
                              ...
                              String    sqlAtrasos1 = "select  a.fecha_solicitud, b.marca, b.modelo,b.fechacompra, a.soporte, a.prioridad, a.estado, a.idsoporte, a.reporte, a.fecha_reporte from sop_soporte_cab a , inv_equipos b where a.idequipo = b.idinvequipo and a.idusuario =  "+codigo+" and a.estado = 'ATENDIDO' order by 1 desc";
