...
<head>
    ...
    <title>ProMaNet - Vacaciones (Administracion)</title>
...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link " href="VAC_Dashboard.jsp">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="VAC_AprobacionesAdmin.jsp">
                    <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="container-fluid py-1 px-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm"><a class="opacity-5 text-white" href="VAC_Dashboard.jsp">Vacaciones</a></li>
                    <li class="breadcrumb-item text-sm text-white active" aria-current="page">Aprobaciones</li>
                </ol>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <h6>Pendientes de aprobacion Administracion</h6>
                        <p class="text-xs text-secondary mb-0">Ya aprobadas por el jefe directo del solicitante.</p>
                    </div>
                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Aprobado por (jefe)</th>
                                            ...
                                            if (cn != null) {
                                                try (PreparedStatement st = cn.prepareStatement(
                                                    ...
                                                    <%
                                                        ...
                                                        if (!hay) {
                                                    %>
                                                    <tr><td colspan="6" class="text-center text-muted py-4">No hay solicitudes pendientes de Administracion.</td></tr>
                                                    <%
                                                        }
                                                    }
...
<div class="modal fade" id="modalAprobar" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="../VAC_GestionarSolicitudAdmin" method="post">
                <input type="hidden" name="idSolicitud" id="aprobarIdSolicitud">
                <input type="hidden" name="accion" value="APROBAR">
                <div class="modal-header" style="background:#198754;">
                    <h5 class="modal-title text-white"><i class="fa fa-check-circle me-2"></i>Aprobar Solicitud</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success btn-sm"><i class="fa fa-check me-1"></i>Aprobar</button>
                </div>
            </form>
        </div>
    </div>
...
<%-- Modal: rechazar --%>
<div class="modal fade" id="modalRechazarAdmin" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="../VAC_GestionarSolicitudAdmin" method="post">
                <input type="hidden" name="idSolicitud" id="rechazarAdminIdSolicitud">
                ...
                <div class="modal-body">
                    <p class="text-sm mb-3">Solicitante: <strong id="rechazarAdminNombreSolicitante"></strong></p>
                    <div class="form-group mb-0">
...
<script>
    ...
    document.querySelectorAll('.btn-rechazar-admin').forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            document.getElementById('rechazarAdminNombreSolicitante').textContent = this.getAttribute('data-nombre');
