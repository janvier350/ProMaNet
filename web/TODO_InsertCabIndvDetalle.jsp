...
<%  String codigo = (String) session.getAttribute("cod");
    ...
    String idCabTodoDetIndv = request.getParameter("idCabTodoDetIndv");
    ...
    <body>
     <%                      
        ...
        try{
            ...
            String sql = "select nvl(max(IDTODODETINDV),0)+1 secuencia from TODODETATRABINDV";
        ...
        /*String sql2 = "insert into TODODETATRABINDV values ("
        ...
        + " to_date('"+fechacont+" 09:00:00', 'yyyy/mm/dd hh24:mi:ss'), " +cliente+" , 'A' , '"+Comentario+"' , "+area+" , 'P',"+grupo+")";*/

        String sqlDetaIndv = "insert into TODODETATRABINDV values ("+idCAB+","+idCabTodoDetIndv+",'"+Actividad+"',to_date('"+fechaini+" 09:00:00', 'yyyy/mm/dd hh24:mi:ss'),'P' )";
        boolean r= true;
        try{
            DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
            Connection cn2 = DriverManager.getConnection(url, user, pass);
            PreparedStatement st2 = cn2.prepareStatement(sqlDetaIndv);
