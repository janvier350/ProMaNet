...
<html>
    <head>
        ...
        <title>ProMaNet | Agregar Colega</title> 
    ...
    <div class="row">
		...
		<div class="panel-heading">
                                                <h3 class="panel-title"><b>Selecci�n de colegas que lo acompa�aran en la reuni�n</b></h3>
                                                <!--<span class="pull-right clickable"><i class="glyphicon glyphicon-chevron-up"></i></span>-->
                                    </div>
		<div class="panel-body"> <%String idCabeceraDetalle = idRegistroAgenda;%>
                    <form  action="FormulariosServlet?idRegistroAgenda=<%=idCabeceraDetalle%>&cbm_anio=<%=cbm_anio%>"  method="POST" >
                                     ...
                                     <div>
                                         <span class="control-label-addon" for="inputdefault">   </span>
                                                         ...
                                                         <table class="table table-hover" id="dev-table">
                                                                ...
                                                                <tbody>
                                                                    <% int contador =0;
                                                                                    ...
                                                                                    <tr>
                                                                                        <td><%=contador%></td>
                                                                                        <td id="departamento" name="departamento"> <%= rs.getString(4) %>     :      </td>
                                                                                        <% String departa = rs.getString(4); %>
                                                                                        <td><label class="form-check-label" id="apellidos">        <%=rs.getString(2)%> </label></td>
                                             ...
                                             <!--se oculta con hidden los colegas seleccionados-->
                ...
                boton.addEventListener('click', function (){
                    lista.innerHTML = '';
                        ...
                        if(e.checked == true){
                            ...
                            elemento.value = e.value;
                            apellido.apellidos = e.name;
                            elemento.innerHTML = e.value + e.name;
                            
                            lista.appendChild(elemento);
                          //  location.href = "FormulariosServlet.java?listaColega="+lista_input;
