        ...
        <tbody>
            ...
            <td align="center" >
                <button type="button" class="btn btn-default " data-bs-toggle="tooltip" title="Crear Cita!" href="#" data-toggle="modal" data-target="#myModal">
                    <i class="material-icons"  data-bs-toggle="tooltip" title="Crear Cita!" style="font-size:30px;">person_add</i>
                </button> 
        ...
        <div class="form-group">
            <div class="table-responsive">
                <table id="example" class="table table-striped table-hover " >
                    <thead>
                      <tr class="success">
                           <th class="text-center titulo "># <span class="badge bg-primary rounded-pill"> <%=conta++ %></span></th>
                        ...
                        <th class="text-center titulo ">OBSERVACI�N</th>  
                    ...
                    <tbody align="auto">
                        ...
                        try{
                            ...
                            String sql ="SELECT a.id_adm_cab_agenda,to_char(a.fecha_age_ini, 'DD-MM-YY')  ,a.hora_age_ini, a.hora_age_fin, c.nombre ||' '|| c.apellidos,b.cliente, a.observacion, a.estado, a.id_cliente,a.estado_agenda, a.area from adm_cab_agenda a, cliente b, usuario c where  a.id_usuario = c.idusuario and a.id_cliente = b.idcliente AND a.ESTADO = 'A' order by 2 ";
                        ...
                        <tr>
                            ...
                            <td align="auto"> <b><%=rs.getString(11)%></b></td>
                            <td><b> <%=rs.getString(5)%></b>
                                <p>Colegas: </p>
                                <div class="">
                                                    ...
                                                    while (rs3.next()){
                                                       ...
                                                       <p> 
                                                         ...
                                                         <%  if(cargo.equals("ADMINISTRACION")||cargo.equals("ADMINISTRADOR")||cargo.equals("CONTRALOR")){%>
                                                           <a href="ADM_EliminarColega.jsp?idColega=<%= rs3.getString(5)%>" class="btn btn-xs btn-danger" data-bs-toggle="tooltip" title="Elimnar Colega!"><span class="glyphicon glyphicon-minus"></span> </a>
                                                        </span> </a> <%}%> * <%=rs3.getString(2)%>  <%=rs3.getString(1)%>
...
<!--                            <div class="action">
                                ...
                                <a href="ADM_EliminarAgenda.jsp?idRegistroAgenda=<%= rs.getString(1)%>" class="btn btn-xs btn-default"data-bs-toggle="tooltip" title="Elimnar!"><span class="glyphicon glyphicon-remove"></span> </a>
                               ...
                               <a href="ADM_CancelarAgenda.jsp?idRegistroAgenda=<%= rs.getString(1)%>" class="btn btn-xs btn-warning " data-bs-toggle="tooltip" title="Editar Cita!"><span class="glyphicon glyphicon-pencil"></span> </a>
                                <a href="ADM_CancelarAgenda.jsp?idRegistroAgenda=<%= rs.getString(1)%>" class="btn btn-xs btn-danger " data-bs-toggle="tooltip" title="Cancelar Cita!"><span class="glyphicon glyphicon-ban-circle"></span> </a>
                                </div>-->
                            </td>
                            <td > <%=rs.getString(6)%>
                            ...
                            <td align="auto"> <%=rs.getString(7)%></td>
                            <td align="center"> 
                                <%  if(cargo.equals("ADMINISTRACION")||cargo.equals("ADMINISTRADOR")||cargo.equals("CONTRALOR")||cargo.equals("")){%>
                                 <!--<a href="#" class="btn btn-xs btn-primary"data-bs-toggle="tooltip" title="Agregar Colegas!" data-toggle="modal" data-target="#myModalGrupo">+<span class="glyphicon glyphicon-user"></span> </a>-->
                                 <a href="Agenda_Agregar_Colega.jsp?idRegistroAgenda=<%= rs.getString(1)%>" class="btn btn-xs btn-primary"data-bs-toggle="tooltip" title="Agregar Colega!">+<span class="glyphicon glyphicon-user"></span> </a>
    ...
    <div class="modal-header">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <label class=" control-label" for="Correo">Ejecutivo</label>
                <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="h_inicio" id="h_inicio" class="form-control" placeholder="09:00" required />
            </div>
            </div>
            <div class="col-lg-6">
            <div class="form-group">
                <label for="Contacto" class="form-control-label">HORA FIN</label>
                <input type="text" name="h_fin" id="h_fin" class="form-control" placeholder="15:00" required   />
            </div>  
            </div>
            </div>
            <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                                <select class="chosen-select form-control" id="cliente" name ="cliente">
            ...
            <div class="col-lg-12">
                <div class="form-group">
                    <label for="Observacion" class="form-control-label">Observaci�n</label>
...
//                                                "select * from Usuario where estado = 'a' order by 2";
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
                <button type="button" id="boton" class="btn btn-success"> Confirmar selecci�n </button>
                <button type="submit"  class="btn btn-primary">Guardar</button>
