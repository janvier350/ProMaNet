...
<div class="container" align="center">
    ...
    <tr>
        ...
        <th style="text-align:center" colspan="5">A�adir Mes </th>
    ...
    <tr>
        ...
        <td style="text-align:center" colspan="5">
            <a href="generarReporteGastos" class="btn btn-success" title="A�adir" style="width: 75px; border-radius: 5px;">
...
<!--        <td style="text-align:center" colspan="5">
        ...
        <td style="text-align:center" colspan="5">
            <a href="generarReporteGastos" class="btn btn-danger" title="A�adir" style="width: 75px; border-radius: 5px;">
            <!--<i class="fa fa-calendar" style="font-size:20px"></i>-->
             <i class="material-icons" font-size:30px">date_range</i>
            </a>
        </td>
