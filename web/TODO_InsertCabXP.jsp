<%-- 
    Document   : Insertar Cabecera de Trabajo de XP
    Created on : 30-Jul-2018, 12:01:01
    Author     : Jquinde
--%>
...
<html>
    ...
    <body>
     <%                      
        ...
        + " to_date('"+fechacont+" 18:00:00', 'yyyy/mm/dd hh24:mi:ss'), " +cliente+" , 'A' , '"+Comentario+"' , "+area+" , 'P','1',"+idJefe+")";
        boolean r= true;
        try{
            DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
