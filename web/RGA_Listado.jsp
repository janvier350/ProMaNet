<%-- 
    Document   : LISTADO DE JEFES (PADRES)
...
<html>
    <head>
        ...
        <title>ProMaNet|Lista de Jefes</title>
    ...
    <div class="container">
    <div class="form-group" >
        <h3>LISTADO DE JEFES PARA ASIGNACION DE HIJOS</h3>
<br>
    ...
    <tr class="success">
        ...
        <th class="text-center">Ver Hijos</th>
    </tr>
    <%
    try{
        DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
        Connection cn = DriverManager.getConnection(url, user, pass);
        String sql = "select a.IDUSUARIO, a.NOMBRE||' '||a.APELLIDOS as nombre, a.USUARIO, b.IDROL, b.CARGO from usuario a, rol b "
                + " where b.IDROL= a.IDROL and (a.IDROL= 4 or a.IDROL= 5 or a.IDROL=6) and a.ESTADO= 'a' order by 2";
    ...
    <tr>
        ...
        <td>
            <a href="RGA_VerAsignados.jsp?id=<%=rs.getString(1)%>&user=<%=rs.getString(2)%>" class="btn btn-primary ">
