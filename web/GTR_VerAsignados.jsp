<%-- 
    Document   : Asignado al Grupo de Trabajo
...
<html>
    <head>
        ...
        <title>ProMaNet|Asignado De Grupos</title>
...
//            var idAsignado = elem[0];
            location.href = 'GTR_InsertarAsignado.jsp?idAsignado='+valor+'&id=<%=idCabGrupo%>'
        }
        </script>
    </head>
    <body>
    ...
    <div class="container" align="center">
        <table>
            <tr>
                <td colspan="3">
                    <a href="Grupo_Trabajo.jsp" class="btn btn-success" title="Regresar" style="width: 75px">
                    <i class="fa fa-mail-reply" style="font-size:20px"></i></a> 
                    <p style="color:black" align="center"><b>Regresar</b></p>
                </td>
                <td colspan="3">
                    <a onclick="Insertar()" class="btn btn-primary" title="Agregar" style="width: 75px">
    ...
    <div class="container">
    <div class="form-group" >
        <h3 class="text-center">Listado de Usuarios asigando al Grupo de Trabajo</h3>
    <form name="formul">                  
        <select class="chosen-select form-control" id="idHijo" name ="idHijo">
        ...
        try{
            ...
            String sql = "Select IDUSUARIO, NOMBRE||' '||APELLIDOS as nombre,IDROL,ESTADO From usuario where ESTADO='a' and "
                    + " Not IDUSUARIO In (select a.IDUSUARIO from TODODETGRUPO a where a.IDTODOCABGRUPO = "+idCabGrupo+" ) order by 2 ";
...
<br>
    ...
    try{
        DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
        Connection cn = DriverManager.getConnection(url, user, pass);
        String sql = "select D.IDTODOCABGRUPO ,A.IDUSUARIO, B.USUARIO,B.NOMBRE||' '||B.APELLIDOS as nombre, C.CARGO , A.IDTODODETGRUPO, D.NOMBREGRUPO "
                + " from TODODETGRUPO A, usuario B, rol C , TODOCABGRUPO D "
                + " where D.IDTODOCABGRUPO = "+idCabGrupo+" and D.IDTODOCABGRUPO = A.IDTODOCABGRUPO and a.IDUSUARIO = b.IDUSUARIO and b.ESTADO='a' and b.IDROL= c.IDROL order by 4";
        PreparedStatement st = cn.prepareStatement(sql);
        ResultSet rs = st.executeQuery();       
    while (rs.next()) {
    ...
    <tr>
        ...
        <td>
            <a href="GTR_EliminaAsignado.jsp?id=<%=rs.getString(6)%>&idCabGrupo=<%=rs.getString(1)%>" class="btn btn-danger ">
