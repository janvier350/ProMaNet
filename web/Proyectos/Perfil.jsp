...
<html>
    ...
    <% String sql =""; 
String imagen =""; String marca =""; String modelo =""; String serial ="";  String idInvEquipo = "";
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Nick Usuario</label>
                                            <input class="form-control" type="text" value="<%=usuario%>" disabled="true">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">E-mail </label>
                                            <input class="form-control" type="email" value="<%=email%>" disabled="true">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" value="<%=cargo%>" disabled="true">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <form action="../ActualizarContrasena.jsp" method="post"> 
                                        <div class="col-md-6">
                                            <div class="form-group pass_show">
                                                ...
                                                <input class="form-control " type="password" name="pass1" id="passv1"  >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group pass_show">
                                                <label for="example-text-input" class="form-control-label">Nueva Contraseña</label>
                                                <input class="form-control" type="password" name="pass2" id="passv2" >
                                            </div>
                                        </div>
                                        <div class="form-group">
