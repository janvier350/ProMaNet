      ...
      <div class="row">
        <div class="col-md-8">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Descripción general de la actividad" value="<%=tarea%>" readonly="true">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label"> Descripción</label>
                    <input class="form-control" type="text"  placeholder="Detalle funciones de la tarea" required="true" value="<%=descripcion%>" readonly="true">
                  </div>
                </div>
                  <form action="../PRO_InsertNuevaTarea" method="POST">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                     <input class="form-control" type="text"  value="<%=departamento%>" readonly="true">
         ...
         <input type="hidden" name="idSolicitud" value="<%=idSolicitud%>">
                  ...
                  <form action="../TODO_insertDetalleTarea" method="POST">
                      <div class="row">
                         <div class="col-md-12">
                             <div class="form-group">
                                <i class="ni education_hat mr-2"></i><b>Tarea </b> 
                                <input type="hidden" name="idCabTarea" value="<%=idCabTarea %>">
                                <div class="input-group mb-3">
                                        <textarea  type="form-control"   class="form-control" name="detalleTarea" > </textarea>
                                </div>
                      </div>
                      </div>
                                <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success" >
                            <i class="fa fa-save" aria-hidden="true">  </i>  Registrar sub-tarea
                          </button>
                      </div>
                 </div>
                  ...
                  <tbody>
                       <% 
                        try{
                            DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
                            Connection cn = DriverManager.getConnection(url, user, pass);
                            String sqlw = "select * from todo_det_tareas where id_todo_cab_tareas = "+idCabTarea+" order by 5";
...
<!--                      <td class="align-middle text-center text-sm">
                      ...
                      <td class="align-middle text-center text-sm">
                            ...
                            <a class="btn btn-xs btn-danger " href="../TODO/PRO_EliminarDetalleTarea.jsp?idCabTrab=<%=rs.getString(1)%>&jefeAsignado=<%= String.valueOf(rs.getString(2))%>&idCabTarea=<%=rs.getString(3)%>">
