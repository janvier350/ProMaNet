          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Crear nuevo item de TODO</p>
                <!--<button class="btn btn-primary btn-sm ms-auto">Settings</button>-->
              </div>
            </div>
            <div class="card-body">
              <p class="text-uppercase text-sm">Información TODO</p>
              <div class="row">
                  <form action="../TODO_insertTareaCab" method="POST">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Tarea</label>
                    <input class="form-control" type="text" placeholder="Descripción general de la actividad " name="tarea">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label"> Descripción</label>
                    <input class="form-control" type="text"  placeholder="Detalle funciones de la tarea" required="true" name="descripcion">
                  </div>
                </div>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control" name="idDepartamento" required>
                                        ...
                                        <%try{
                                         DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
                                         Connection   cn = DriverManager.getConnection(url, user, pass);
                                         String sql4 = "select IDTODOAREA, DESCRIPCION, ACTIVIDADES from TODOAREA where ESTADO = 'A'  order by 2 asc";
...
<!--                                    <select class="chosen-select form-control" id="idDepartamento" name ="idDepartamento">
...
<!--                                            <button type="#" class="btn btn-info"  href="">
                                           ...
                                           <button type="submit" class="btn btn-success" >
                                               <i class="fa fa-save" aria-hidden="true">  </i> Registrar Tarea
                                             </button>
                                        </div>
...
<!--                <div class="col-md-6">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Lista de tareas existentes</h6>
            </div>
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">DEPARTAMENTO</th>
                       <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">SUB-TAREAS</th>
                  ...
                  <tbody>
                       <% 
                        try{
                            DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
                            Connection cn = DriverManager.getConnection(url, user, pass);
                            String sqlw = "SELECT A.ID_TODO_CAB_TAREAS, A.ID_ADM_DEPARTAMENTO, A.TAREA, A.DESCRIPCION, A.ESTADO, b.descripcion FROM TODO_CAB_TAREAS A , TODOAREA B WHERE a.id_adm_departamento = b.idtodoarea order by 1";
                            PreparedStatement st = cn.prepareStatement(sqlw);
                            ResultSet rs = st.executeQuery();       
                            while (rs.next()) {%>
...
<!--                      <td>
                      ...
                      <td class="align-middle text-center text-sm">
                           <p class="text-xs font-weight-bold mb-0"><%=rs.getString(6)%></p>
...
<!--                        <a href="javascript:;" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                            ...
                            <a class="btn btn-xs btn-warning " href="../Proyectos/PRO_NUEVO_DETALLE_TAREA.jsp?idCabTarea=<%=rs.getString(1)%>&tarea=<%= String.valueOf(rs.getString(3))%>&descripcion=<%=rs.getString(4)%>&departamento=<%=rs.getString(6)%>">
