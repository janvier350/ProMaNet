              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <p class="mb-0">
                        <span class="text-success text-sm font-weight-bolder"><b>Consulte tarjetas  </b></span>
                ...
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <p class="mb-0">
                      ...
                      <b class="text-dark">el ingreso de un nuevo ejecutivo.</b>
                    </p>
                  </div>
                </div>
                <div class="col-4 text-end">
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <p class="mb-0">
                      <span class="text-danger text-sm font-weight-bolder">Mejore su </span>
                      <b class="text-danger">productividad registrando tareas.</b>
                    </p>
                  </div>
                </div>
                <div class="col-4 text-end">
...
<%if(roltodo.equals("ASISTENTE")){%>
    ...
    try{
        ...
        String sqlAsistente ="";
        sqlAsistente = "SELECT to_char(B.FECHAHORAASIG, 'DD-MM-YY'),to_char(b.FECHAFIN, 'DD-MM-YY'),to_char(b.FECHALEGAL, 'DD-MM-YY') ,a.CLIENTE, b.TRABAJO, b.ESTTRAB,b.IDTODOCAB "
        ...
        PreparedStatement st5 = cn5.prepareStatement(sqlAsistente);
    ...
    while (rs5.next()) {%>
                  ...
                  <tr>
                      ...
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                            <a class="btn btn-xs btn-primary " href="../TODO_det_Trabajo_1.jsp?idCabTrab=<%=rs5.getString(7)%>">
                    ...
                    <td class="w-30">
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                            <!--<a  href="../TODO_det_Trabajo_1.jsp?idCabTrab=<%=rs5.getString(7)%>">-->
                        ...
                        <div class="ms-4">
                          ...
                          <h6 class="text-sm mb-0"><%= String.valueOf(rs5.getString(4))%></h6>
                        </div>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        ...
                        <h6 class="text-sm mb-0"><%= String.valueOf(rs5.getString(9))%></h6>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                        <!--<p class="text-xs font-weight-bold mb-0">Fecha Inicio:</p>-->
                        <h6 class="text-sm mb-0"><%= String.valueOf(rs5.getString(1))%></h6>
                      </div>
                    </td>
                    <td>
                      <div class="text-center">
                    ...
                    <td class="align-middle text-sm">
                      <div class="col text-center">
                        ...
                        <h6 class="text-sm mb-0"><%= String.valueOf(rs5.getString(2))%></h6>
                      </div>
                    </td>
                  </tr>
...
<!--                  <tr>
      ...
      <div class="row mt-4">
        <div class="col-lg-7 mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Lista de tareas asignadas </h6><p><%=roltodo%></p>
              <p class="text-sm mb-0">
                <i class="fa fa-arrow-up text-success"></i>
                <span class="font-weight-bold">4% more</span> in 2023
              </p>
...
<div class="table-responsive overflow-auto" style="max-height: 400px;">
    ...
    try{
        ...
        String sql4 ="";
        sql4 = "select a.idtodoasigtarea, a.idtododettrab, TO_CHAR(a.fechahoraasig, 'DD/MM/YYYY') AS fech_asignada,b.idtododet,b.idtodocabtrab,b.detalle, TO_CHAR(b.fechahorainicio, 'DD/MM/YYYY') AS fech_inicio, TO_CHAR(b.fechahorafin, 'DD/MM/YYYY') AS fech_fin,b.est_det_trab from todoasigtarea a, tododettrab b where idusuario = "+codigo+" and a.idtododettrab = b.idtodocabtrab and b.estado = 'A' order by a.idtodoasigtarea desc";
                  ...
                  <tr>
                      ...
                      <div class="d-flex px-2 py-1 align-items-center">
                        <div>
                            ...
                            <a class="btn btn-xs btn-primary " href="../TODO_det_Trabajo_1.jsp?idCabTrab=<%=rs4.getString(1)%>">
                                <i class="fas fa-eye"></i>
                            </a>
...
<!--                        <div class="ms-4">
            ...
            <%=rs4.getString(6)%>
                    ...
                    <td>
                      <div class="text-center">
                        <!--<p class="text-xs font-weight-bold mb-0">Jefe Asignado:</p>-->
                        <h6 class="text-sm mb-0"><%= String.valueOf(rs4.getString(7))%></h6>
                      </div>
                    </td>
                    ...
                    <td>
                      <div class="text-center">
                        ...
                        <%if(rs4.getString(9).equals("P")){%>
                        <h6 class="text-sm mb-0"  title="El proyecto se encuentra en proceso." style="background-color: yellow">PENDIENTE</h6>
                            <!--<td type="text"title="El proyecto se encuentra en proceso." style="background-color: yellow"> PENDIENTE</td>-->
                        <%}%>
                        <%if(rs4.getString(9).equals("T")){%>
                        <h6 class="text-sm mb-0" title="Proyecto Terminado." style="background-color: #99ff66">TERMINADO</h6>
                            <!--<td type="text"title="Proyecto Terminado." style="background-color: #99ff66">  TERMINADO</td>-->
                        <%}%>
                        <%if(rs4.getString(9).equals("A")){%>
                        <h6 class="text-sm mb-0" title="Proyecto Atrasado." style="background-color: #ff9999">ATRASADO</h6>
                            <!--<td type="text"title="Proyecto Atrasado." style="background-color: #ff9999">  ATRASADO</td>-->
                        <%}%>
                        <%if(rs4.getString(9).equals("R")){%>
                        <h6 class="text-sm mb-0"  title="Proyecto Reversado." style="background-color: #ff5722">REVERSADO</h6>
                            <!--<td type="text"title="Proyecto Reversado." style="background-color: #ff5722">  REVERSADO</td>-->
                        <%}%>
                      </div>
                    ...
                    <td>
                      <div class="text-center">
                        <!--<p class="text-xs font-weight-bold mb-0">Fecha Inicio:</p>-->
                        <h6 class="text-sm mb-0"><%= String.valueOf(rs4.getString(8))%></h6>
                      </div>
                    </td>
                    <td class="align-middle text-sm">
                      <div class="col text-center">
          ...
          <div class="card ">
            <div class="card-header pb-0 p-3">
              <div class="d-flex justify-content-between">
                <h6 class="mb-2">Lista de proyectos en General</h6>
                <p><%=roltodo%></p>
              </div>
            </div>
            <div class="table-responsive overflow-auto" style="max-height: 400px;">
    ...
    try{
        ...
        String sql4 ="";
         if(roltodo.equals("JEFE")){
           sql4 = "SELECT to_char(B.FECHAHORAASIG, 'DD-MM-YY'),to_char(b.FECHAFIN, 'DD-MM-YY'),to_char(b.FECHALEGAL, 'DD-MM-YY') ,a.CLIENTE, "
                   + "b.TRABAJO, b.ESTTRAB,b.IDTODOCAB ,b.IDJEFEASIG, C.NOMBRE||' '||C.APELLIDOS, b.idtodocabgrupo from cliente a,TODOCABTRAB b , USUARIO C "
                   + "where a.IDCLIENTE = b.IDCLIENTE and b.ESTADO = 'A' and (b.IDUSUARIO= "+codigo+" or b.IDJEFEASIG= "+codigo+") and b.ESTTRAB "+EstTrab+" and b.IDJEFEASIG=C.IDUSUARIO  order by 7 DESC";
        }else if(roltodo.equals("ASISTENTE")||roltodo.equals("ASISTENTE")){
           sql4 = "SELECT to_char(B.FECHAHORAASIG, 'DD-MM-YY'),to_char(b.FECHAFIN, 'DD-MM-YY'),to_char(b.FECHALEGAL, 'DD-MM-YY') ,a.CLIENTE, b.TRABAJO, b.ESTTRAB,b.IDTODOCAB "
             + " from cliente a,(SELECT DISTINCT B.IDTODOCABTRAB, A.IDTODOCAB, A.IDUSUARIO, A.DESCRIPCION, A.TRABAJO, "
             + " A.FECHAINCIO, A.FECHAFIN, A.FECHAHORAASIG, A.FECHALEGAL, A.FECHACONTRATO, A.IDCLIENTE, A.ESTADO, A.COMENTARIO, A.IDTODOAREA, A.ESTTRAB, A.IDTODOCABGRUPO "
             + " FROM TODOCABTRAB A,TODODETTRAB B, TODOASIGTAREA C WHERE A.IDTODOCAB = B.IDTODOCABTRAB AND B.IDTODODET = C.IDTODODETTRAB "
...
//                                    sqlAtrasosALL ="WITH RankedAtrasos AS ( SELECT c.apellidos,  a.id_usuario, c.nombre,TO_CHAR(a.fecha_notificacion, 'MM/YYYY') AS mes_y_anio_notificacion, b.descripcion,TO_CHAR(a.fecha_notificacion, 'HH24:MI') AS hora_notificacion, ROW_NUMBER() OVER (PARTITION BY a.id_usuario ORDER BY a.fecha_notificacion DESC) AS rn, COUNT(*) OVER (PARTITION BY a.id_usuario) AS total_atrasos FROM rep_biom_atraso a INNER JOIN reg_biom_motivo b ON a.id_rep_biom_motivo = b.id_biom_motivo INNER JOIN  usuario c ON a.id_usuario = c.idusuario WHERE a.estado = 'A' AND a.fecha_notificacion < CURRENT_TIMESTAMP) SELECT apellidos,  id_usuario, nombre,  mes_y_anio_notificacion, descripcion, hora_notificacion,total_atrasos FROM  RankedAtrasos WHERE   rn = 1 ORDER BY  mes_y_anio_notificacion DESC";
 solicitudes = "select  a.apellidos, a.nombres, TO_CHAR(a.fecha_ingreso, 'DD/MM/YYYY') ,b.nombre, b.apellidos,TO_CHAR(a.fecha_notificacion, 'DD/MM/YYYY HH24:MI') , a.compania,a.rol, a.actividades,  a.estado, a.idnotificaciones, a.jefe_inmediato FROM adm_notificaciones a INNER JOIN usuario b ON a.id_usuario_solicitante = b.idusuario WHERE   a.estado = 'PENDIENTE' ";
...
<!--                      <td class="align-middle text-center">
             ...
             <%}else if(rsa1.getString(10).equals("PENDIENTE")){%>
                        <button class="btn btn-link text-primary mb-0">
                            <a href="../Proyectos/PRO_AtenderNotificacion.jsp?idNotificacion=<%= rsa1.getString(11)%>"> <i  class="fa fa-check text-xs"></i> </a>
                        </button>
                        <%}%>
                      </td>
                    </tr>
