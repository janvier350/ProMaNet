    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Compromisos</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Proyecto - Compromiso cabecera</h6>
            </div>
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                  <%
                    ...
                    while (rs.next()) {%>
                    <div class="card-body">
                        <p class="text-uppercase text-sm">Compania / Cliente:  <b><%= rs.getString(8)%></b></p>
                        <p class="text-uppercase text-sm">Jefe Asignado:  <b><%=jefeAsignado%></b></p>
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input class="form-control" type="text" value=" <%= rs.getString(2)%>" disabled="true">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Fecha Fin </label>
                     <label for="example-text-input" class="form-control-label"> </label>
                    <input class="form-control" type="email" value=" <%= rs.getString(3)%>" disabled="true">
                  </div>
                </div>
                  <div class="col-md-3">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Fecha Legal</label>
                     <label for="example-text-input" class="form-control-label">  </label>
                    <input class="form-control" type="text" value=" <%= rs.getString(4)%>" disabled="true">
                  </div>
                </div>
                  <div class="col-md-3">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Fecha Contrato</label>
                     <label for="example-text-input" class="form-control-label">  </label>
                    <input class="form-control" type="text" value=" <%= rs.getString(5)%>" disabled="true">
                  </div>
                </div>
                  
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Trabajo - Compromiso: <%= rs.getString(12)%></label>
                    <input class="form-control" type="text" value=" <%= rs.getString(12)%>" disabled="true">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Area: <%= rs.getString(6)%></label>
                    <input class="form-control" type="text" value=" <%= rs.getString(6)%>" disabled="true">
                  </div>
                </div>
                  <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Descripcionl</label>
                    <input class="form-control" type="text" value="  <%= rs.getString(11)%>" disabled="true">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Estado</label>
                    <input class="form-control" type="text" value=" <%= rs.getString(9)%>" disabled="true">
                  </div>
                </div>
                  <div class="col-md-12">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Comentario</label>
                    <input class="form-control" type="text" value=" <%= rs.getString(10)%>" disabled="true">
                  </div>
                </div>
            ...
            <div class="card-header pb-0" >
              ...
              <td><a class="btn btn-success" href="../TODO_TerminarCabTrab.jsp?idCab=<%=cabTrab %>"><i class="fa fa-check " style="color:green;font-size:21px"></i>Terminar Trabajo</a></td>   
            </div>
            
                  <div class="card-header pb-0" data-bs-toggle="modal" data-bs-target="#exampleModalSignUp">
              <h6>Asignar tarea a un ejecutivo.</h6>
              <a class="btn btn-xs btn-primary "  <i class="fas fa-plus"></i>    Asignar nueva tarea</a>
            </div>
                      
                      
                      <div class="card-header pb-0">
              <h6>Crear Nuevas Tareas</h6>
...
<!--                  <label>Current Password</label>
        ...
        <!--modal asignar tarea a ejecutvo-->
          ...
          <div class="modal-body p-0">
            <div class="card card-plain">
              <div class="card-header pb-0 text-left">
                  <h3 class="font-weight-bolder text-primary text-gradient">Asignar tarea a ejecutivo:</h3>
                  <!--<p class="mb-0">Ingresar datos</p>-->
              </div>
              <div class="card-body pb-3">
                  <form role="form text-left" action="../TODO_InsertTrabajo.jsp?idCab2=<%=cabTrab%>">
                  ...
                  <div class="input-group mb-3">
                    <input type="date" class="form-control"  aria-label="Name" aria-describedby="name-addon" name="fechaini"  id="fechaini">
                     <script>
                  ...
                  <div class="input-group mb-3">
                    <input type="date" class="form-control"  aria-label="Name" aria-describedby="name-addon" name="fechafin"  id="fechafin">
                     <script>
                  ...
                  <select class="form-control" name="usuario">
                           <%try{
                            ...
                            String ejecutivo = "select * from usuario where estado = 'a' order by 3";
                            PreparedStatement st2 = cn2.prepareStatement(ejecutivo);
                            ResultSet rs2 = st2.executeQuery();       
                            while (rs2.next()) {%>         
                            <option value="<%=rs2.getString(1)%>"><%=rs2.getString(3)+" "+rs2.getString(2)%></option>
...
<!--                  <div class="input-group mb-3">
                   ...
                   <select class="form-control" id="Trabajo" name="Trabajo" >
                           <%try{
                            ...
                            String tareas = "SELECT * FROM TODO_DET_TAREAS WHERE ID_TODO_CAB_TAREAS = "+idCabTarea+" AND estado = 'A' order by 1";
                            PreparedStatement st3 = cn3.prepareStatement(tareas);
                            ResultSet rs3 = st3.executeQuery();       
                            while (rs3.next()) {%>                                                                    
                               <option><%=rs3.getString(5)+"-"+rs3.getString(3)%></option>
                            <%}     
                                rs3.close();
                                st3.close();
                                cn3.close();
...
<!--              <div class="row">
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-body p-0">
            <div class="card card-plain">
              <div class="card-header pb-0 text-left">
                  <h3 class="font-weight-bolder text-primary text-gradient">TAREAS</h3>
                  <!--<p class="mb-0">Ingresar datos</p>-->
              </div>
              <div class="card-body pb-3">
    ...
    <% try{
      ...
      String sql2 = "select A.IDTODODETTAREA,A.DETALLE, to_char(A.FECHAHORAINICIO, 'DD-MM-YY'),to_char(A.FECHAHORAFIN, 'DD-MM-YY'),A.ESTADO, B.IDTODODET "
                ...
                + "where B.IDTODODET = 877 AND A.IDTODODETTRAB =B.IDTODODET AND A.ESTADO ='A' order by 1";
...
<!--              <div class="row">
                ...
                <!--lista de tareas del ejecutuvo modal-->
                ...
                <table class="table align-items-center justify-content-center mb-0">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Asignado</th>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Detalle</th>
                       <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Estado</th>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Ver TAreas</th>
                         <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Terminar</th>
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Reversar</th>
                ...
                String sql ="";
                  if(roltodo.equals("JEFE")){
                     sql = "select A.IDTODODET,to_char(A.FECHAHORAINICIO, 'DD-MM-YY'),to_char(A.FECHAHORAFIN, 'DD-MM-YY'), A.ESTADO, B.IDUSUARIO, C.NOMBRE||' '||C.APELLIDOS AS NOMBRE, A.DETALLE, "
                        + "(CASE a.est_det_trab WHEN 'P' THEN 'PENDIENTE' WHEN 'A' THEN 'ATRASADO' WHEN 'R' THEN 'RETOMAR' ELSE 'TERMINADO'  END) AS ESTADO, B.IDTODODETTRAB "
...
<!--                      <td>
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm"><%= rs.getString(7)%></h6>
                          </div>
                        </div>
                      </td>-->
<!--<td>codigo
    <%= DetTrabAC = rs.getString(1)%> - <%=DetTrabAC%>
</td>-->
                      <td>
                        <p class="text-sm font-weight-bold mb-0"><%= rs.getString(6)%></p>
                      </td>
                      <td>
                          <p class="text-sm font-weight-bold mb-0">Inicio: <%= rs.getString(2)%></p>
                          <p class="text-sm font-weight-bold mb-0">Fin: <%= rs.getString(3)%></p>
                      </td>
                      <td>
                        <span class="text-xs font-weight-bold"><%= rs.getString(7)%>   </span>
                       <%= DetTrabAC =  rs.getString(9)%>
                      </td>
<!--                       <td>
                        <span class="text-xs font-weight-bold"><%= rs.getString(7)%></span>
...
<!--                      <td class="align-middle text-center">
  ...
  <td><a class="btn btn-xs btn-default" href="../TODO_TerminarDetTrab.jsp?idCab=<%=cabTrab%>&DetTrab=<%=rs.getString(1)%>"> <i class="fas fa-check"></i></a></td>  
            <%if(roltodo.equals("JEFE")){%>                                                                                                                                                                                                              
                ...
                <td ><a class="btn btn-xs btn-danger" data-bs-toggle="tooltip" title="Elimina esta tarea, eliminación en cascada (las tareas aplicadas en este proceso se eliminaran)!" href="../TODO_EliminarTrabajo.jsp?idCab=<%=cabTrab%>&idDetTrab=<%=rs.getString(1)%>"> <i class="fas fa-trash-alt"></i></a></td>
             <%}else if(roltodo.equals("ASISTENTE")){%>
