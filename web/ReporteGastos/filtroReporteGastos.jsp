...
String compania = (String) session.getAttribute("compania");
    ...
    String idRegistroAtraso = request.getParameter("idRegistroAtraso");
  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Reporte de Gastos corte</li>
          </ol>
              ...
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    ...
                    <p class="mb-0">
                      <span class="text-danger text-sm font-weight-bolder">Controle su productividad</span>
                      <b class="text-danger">registrando sus tareas.</b>
                    </p>
                  </div>
                </div>
                <div class="col-4 text-end">
        ...
        <div class="col-lg-7 mb-lg-0 mb-4">
          <div class="card z-index-2 h-100">
            <div class="card-header pb-0 pt-3 bg-transparent">
              <h6 class="text-capitalize">Filtro de reportes de gastos </h6>
            ...
            <div class="card-body p-3">
    <div class="row">
        <form class="form-horizontal" action="../reporteGastosFiltroPDF" method="POST">
            <div class="col-md-4">
            <div class="form-group">
                <label for="fecha_inicio" class="form-control-label">Fecha Inicio</label>
                <input value="" class="form-control" type="date" name="fecha_inicio" id="fecha_inicio">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="fecha_fin" class="form-control-label">Fecha Fin</label>
                <input value="" class="form-control" type="date" name="fecha_fin" id="fecha_fin">
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label for="fecha_fin" class="form-control-label">Imprimir</label>
                <button type="submit" class="btn bg-gradient-danger mb-0 form-control" target="_blank">
    ...
    try{
        ...
        Connection cn4 = DriverManager.getConnection(url, user, pass);
         ...
         String todos = "select count(*) from rep_biom_atraso where id_usuario = "+idRegistroAtraso+" and estado = 'A' ";
