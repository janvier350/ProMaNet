...
//            select a.idrepgasdet, a.idcliente, to_char(a.fecha, 'yyyy-MM-dd'), a.valor, a.trabrealizado,a.totalim,a.totmovi,a.idrepgascab, b.cliente  from rep_gasdet a, cliente b where idrepgascab = 1 and idrepgasdet = 1 and a.idcliente = b.idcliente
            String consulta = " select a.idrepgasdet, a.idcliente, to_char(a.fecha, 'yyyy-MM-dd'), a.valor, a.trabrealizado,a.totalim,a.totmovi,a.idrepgascab, b.cliente  from rep_gasdet a, cliente b where idrepgascab = "+idCab+" and idrepgasdet = "+idDet+"  and a.idcliente = b.idcliente " ;
            PreparedStatement st = cn.prepareStatement(consulta);
            ResultSet rs = st.executeQuery();       
            while (rs.next()) {
              idCliente = rs.getInt(2);
             fecha = rs.getString(3);
             trabajo = rs.getString(5);
             alimentacion = rs.getDouble(6);
             transporte = rs.getDouble(7);
...
String fechacompra =""; String  observaciones=""; String procesador =""; String  ram =""; String ubicacionoficina =""; String fechaasignacion = ""; String hdd = "";
             try{
               DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
               Connection cn = DriverManager.getConnection(url, user, pass);               
                   sql = "select a.fichero,a.marca,a.modelo,a.serial,  to_char(a.fechacompra, 'yyyy-MM-dd'), a.observaciones, a.procesador,a.ram, a.ubicacionoficina, b.fechaasignacion, a.hdd from inv_equipos a left join inv_asignacion b on a.idinvequipo = b.idinvequipo where b.idusuario = "+codigo+" and b.estado = 'A'";
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Editar reporte de gastos</p>
                <!--<button class="btn btn-primary btn-sm ms-auto">Settings</button>-->
              </div>
            </div>
            <div class="card-body">
                <form  action="../editarReporteDiario" method="post">
                     
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                      <input name="idCab" value="<%=idCab%>" hidden id="idCab"><!-- comment -->
                      <input name="idDet" value ="<%=idDet%>" hidden  id="idDet">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input value="<%=fecha%>" class="form-control" type="date"  name ="fecha" id="fecha">
                     
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="" class="form-control-label">Alimentación</label>
                    <!--<input class="form-control" type="number" value="<%=alimentacion%>" name="alimentacion">-->
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">Transporte</label>
                    <!--<input class="form-control" type="number" value="<%=transporte%>"  name="transporte">-->
                  ...
                  <div class="form-group">
                    ...
                    <!--<input class="form-control" type="text" value="Reporte de gastos">-->
                    <textarea class="form-control" id= "Obva"   oninput ="contarLetras()" id="trabajo" name="trabajo"><%=trabajo%></textarea>
