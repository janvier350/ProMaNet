...
<body>
                ...
                <div  class="collapse navbar-collapse " id="navbar-1" >
                    <ul class="nav navbar-nav " >
                        ...
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                            ...
                            <li class="divider"></li>
                            <li class="dropdown-submenu">
                                <a tabindex="-1" href="#">Asignaci�n</a>
                                <ul class="dropdown-menu">
    ...
    <table class="table table-striped ">
        ...
        <tbody>
            <tr>
            <td align="center" >
                <a  href="Agenda_history.jsp" type="button" class="btn btn-default" onclick="tableToExcel('detalles', 'W3C Example Table')" >
                    <i class="material-icons"  data-bs-toggle="tooltip" title="Citas por mes!"  style="font-size:30px">calendar_month</i>     
                </a>
