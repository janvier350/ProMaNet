    ...
    <div class="container ">
        ...
        <div class="col-lg-4" align ="">
            ...
            <p style="font-family: arial"> <strong> Email : </strong> <%=email%></p>
             <p style="font-family: arial"> <strong> Tel�fono : </strong> <%=telefono%></p>
<!--            <button type="button" class="btn btn-default " href="#" data-toggle="modal" data-target="#myModal">
        ...
        <div class="col-lg-4" align ="">
            ...
            <p style="font-family: arial"> <strong> FECHA ASIGNACI�N : </strong> <%=fechaasignacion%></p>
            <p style="font-family: arial"> <strong> Ubicaci�n :</strong> <%=ubicacionoficina%></p>
