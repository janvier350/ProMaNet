...
String compania = (String) session.getAttribute("compania");
    ...
    String depart = "";
     ...
     String apellidosEjecutivo   = request.getParameter("apellidosEjecutivo");
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Atrasos</li>
          </ol>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Lista de atrasos por mes</h6>
               <!--<label><%=ejecutivo%></label>-->
              <h4 class="text-warning"> <%=nombresEjecutivo%> - <%=apellidosEjecutivo%></h4>
...
//                            String sql = "select a.IDUSUARIO, a.NOMBRE, a.APELLIDOS, a.EMAIL, b.COMPANIA  , c.departamento from USUARIO a, compania b, adm_departamento c where a.IDCOMPANIA = b.IDCOMPANIA AND a.ESTADO = 'a' AND a.id_adm_departamento =c.id_departamento order by 1";
                            ...
                            PreparedStatement st = cn.prepareStatement(atrasosMes);
