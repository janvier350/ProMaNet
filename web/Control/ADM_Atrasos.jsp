                        ...
                        <% String sqlAtrasos =""; 
                            ...
                            try{
                              ...
                              Connection cna = DriverManager.getConnection(url, user, pass);               
                                  sqlAtrasos = "select a.id_usuario,c.nombre, c.apellidos ,to_char(A.fecha_notificacion, 'DD/MON/YYYY'), b.descripcion, to_char(fecha_notificacion, 'HH24:MI') AS minuto, a.observacion from rep_biom_atraso a, reg_biom_motivo b, usuario c  where a.id_rep_biom_motivo = b.id_biom_motivo and a.id_usuario = c.idusuario and a.id_usuario =  "+codigo+" and a.estado = 'A' order by 4 desc";
