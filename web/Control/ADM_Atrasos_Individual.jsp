  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Lista atraso individual</li>
          </ol>
    ...
    %>
            ...
            <div class="card-header pb-0">
              ...
              <p class="text-danger"> <b>  <%=ejecutivo%> <br>  Tienes <%= totalAtrasos%> atrasos.</b></p>
            </div>
                        ...
                        <% String sqlAtrasos =""; 
                            ...
                            try{
                              ...
                              Connection cna = DriverManager.getConnection(url, user, pass);               
                                  sqlAtrasos = "select a.id_usuario,c.nombre, c.apellidos ,to_char(A.fecha_notificacion, 'DD/MON/YYYY'), b.descripcion, to_char(fecha_notificacion, 'HH24:MI') AS minuto,fecha_notificacion from rep_biom_atraso a, reg_biom_motivo b, usuario c  where a.id_rep_biom_motivo = b.id_biom_motivo and a.id_usuario = c.idusuario and a.id_usuario =  "+idRegistroAtraso+" and a.estado = 'A' order by 7  desc";
...
//                           totalAtrasos = totalAtrasos + 1;
                    ...
                    <tr>
                        ...
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm"><%=rsa.getString(5)%> </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                      ...
                      <td>
                        <span class="text-xs font-weight-bold"><%=rsa.getString(6)%></span>
                      </td>
