...
<html>
    <head>
        ...
        <title>
            ProMaNet | Fecha de corte anticipos
        </title>
        <!--     Fonts and icons     -->
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder text-white mb-0">Fecha Corte Anticipos</h6>
                    </nav>
                    ...
                    <div class="col-12">
                        <div class="card mb-4">
                            <div class="card-header pb-0">
                                ...
                                <p>Asigne fecha límite para anticipos de sueldo </p>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('corte').setAttribute('min', fechaActual);
});

function validarFecha() {
    var fechaSeleccionada = document.getElementById('corte').value;
    ...
    if (fechaSeleccionadaObj < hoy) {
        Swal.fire({
            ...
            text: 'La fecha de corte no puede ser menor a la fecha actual',
...
<form action="../CTRL_Insert_Fecha_Corte_Anticipo" method="post" onsubmit="return validarFecha()"> 
    <div class="col-md-6">
        <div class="form-group pass_show">
            <label class="form-control-label">Fecha límite anticipos</label>
            <input class="form-control" type="date" name="corte" id="corte" required>
        </div>
    </div>
    ...
    <div class="form-group">
        <button type="submit" class="btn btn-success">
            <i class="fa fa-save" aria-hidden="true"></i> Definir fecha de corte
        </button>
    </div>
</form>
                            ...
                            <div class="col-12">
                                <div class="card mb-4">
                                    <div class="card-header pb-0">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <h6>Lista de fechas de corte para anticipos</h6><label for="example-text-input" class="form-control-label"></label>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table align-items-center justify-content-center mb-0" id="tablaProductos">
                                                ...
                                                <tbody id="tablaProductosBody">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-wrap">
                                                            <p class="text-xs font-weight-bold mb-0"><%=rsa5.getString(4)%></p>
                ...
                <script>
                                            function validarAnticipo() {
                                                ...
                                                const limite = sueldoUsuario * 0.50;

                                                // 3. Validamos
                                                if (valorAnticipo > limite) {
                                                    alert("¡Error! El anticipo solicitado ($" + valorAnticipo + ") supera el 50% de su sueldo ($" + limite + ").");
