      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Lista - Atrasos</li>
          </ol>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                ...
                <table class="table align-items-center justify-content-center mb-0"> 
                  <thead>
                    <tr>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Ejecutivos</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"># Atrasos</th>
...
//                                  sqlAtrasosALL = "select a.id_usuario,c.nombre, c.apellidos ,to_char(A.fecha_notificacion, 'DD/MON/YYYY'), b.descripcion, to_char(fecha_notificacion, 'HH24:MI') from rep_biom_atraso a, reg_biom_motivo b, usuario c  where a.id_rep_biom_motivo = b.id_biom_motivo and a.id_usuario = c.idusuario and a.estado = 'A' order by 4 desc";
                              ...
                              PreparedStatement sta1 = cna1.prepareStatement(sqlAtrasosALL);
                    ...
                    <tr>
                        ...
                        <div class="d-flex px-2">
                          ...
                          <div class="my-auto">
                            <h6 class="mb-0 text-sm"><%=rsa1.getString(1)%> <%=rsa1.getString(3)%> </h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-sm font-weight-bold mb-0"><%=rsa1.getString(7)%> </p>
                      </td>
                      <td>
                        <span class="text-xs font-weight-bold"><%=rsa1.getString(4)%></span>
                      </td>
                       <td>
...
<!--                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle">
                        <button class="btn btn-link text-secondary mb-0">
                            <a href="../Control/ADM_Atrasos_Individual.jsp?idRegistroAtraso=<%= rsa1.getString(2)%>&ejecutivo=<%= rsa1.getString(1)%>"> Ver<i  class="fa fa-eye text-xs"></i> </a>
                        </button>
                      </td>
                      <td class="align-middle">
                        <button class="btn btn-link text-secondary mb-0">
                            <a href="../Control/ADM_Atrasos_Ejecutivo.jsp?nombresEjecutivo=<%= rsa1.getString(1)%>&ejecutivo=<%= rsa1.getString(2)%>&apellidosEjecutivo=<%= rsa1.getString(3)%>"> Mes<i  class="fa fa-eye text-xs"></i> </a>
                        </button>
                      </td>
                    </tr>
                <%
