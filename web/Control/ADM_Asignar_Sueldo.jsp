...
<html>
    ...
    <body class="g-sidenav-show   bg-gray-100">
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Sueldos</li>
                        </ol>
                  ...
                  totalAtrasos = rs4.getString(1);
                                    ...
                                    <table class="table align-items-center justify-content-center mb-0"> 
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Sueldo</th>
                                            ...
                                            <% String sqlAtrasos =""; 
                                                ...
                                                try{
                                                  ...
                                                  Connection cna = DriverManager.getConnection(url, user, pass);               
                                                      sqlAtrasos = "select * from usuario where sueldo = 0 and estado = 'a'";
                                                      String asignar_sueldo = " SELECT a.idusuario , a.nombre, a.apellidos, a.sueldo, b.departamento, a.email FROM USUARIO A, ADM_DEPARTAMENTO B WHERE a.id_adm_departamento = b.id_departamento AND B.departamento IN ('MARKETING', 'TECNOLOGÍA', 'IMPUESTOS', 'ADMINISTRACIÓN', 'CONTABILIDAD', 'LEGAL') and sueldo = 0 AND A.estado = 'a'";

                                                  PreparedStatement sta = cna.prepareStatement(asignar_sueldo);
                    ...
                    //                           totalAtrasos = totalAtrasos + 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-sm font-weight-bold mb-0"><%=rsa.getString(5)%> </p>
                            <!--                         <p class="text-sm font-weight-bold mb-0"><%=rsa.getString(1)%> </p>-->
                                                      <!--<p class="text-sm font-weight-bold mb-0"><%=rsa.getString(4)%> </p>-->
                                                </td>
                     ...
                     if(cargo.equals("ADMINISTRACION")||cargo.equals("ADMINISTRADOR")||cargo.equals("CONTRALOR")||cargo.equals("JEFE")){%>
                                                <td class="align-middle">
                                                    <button type="#" class="btn btn-warning"  href="" data-id="<%= rsa.getString(1)%>" data-apellido="<%=rsa.getString(2)%>" data-nombre="<%=rsa.getString(3)%>"  data-bs-toggle="modal" data-bs-target="#exampleModalSignUp2">  Asignar Sueldo</button>
                                                  <!--<a href ="../Soportes/SOP_EditarSolicitudes.jsp?idSolicitud=<%= rsa.getString(1)%>&fecha=<%= rsa.getString(1)%>&soporte=<%= rsa.getString(5)%>&prioridad=<%= rsa.getString(1)%>&estado=<%= rsa.getString(1)%>" class="btn btn-sm btn-warning mb-0 d-none d-lg-block "> Atender</a>-->
                                                </td>
                                                <%}%>
                                                <!--                      <td class="align-middle">
                                                                        <a href ="../SOP_EliminarSolicitud?idSolicitud=<%= rsa.getString(1)%>" class="btn btn-sm btn-danger mb-0 d-none d-lg-block "> Eliminar</a>
                                                                      </td>-->
                                            </tr>
                                            <%
                                          } rsa.close();
                                        ...
                                        <div class="modal-body p-0">
                                            <div class="card card-plain">
                                                <div class="card-header pb-0 text-left">
                                                    <h3 class="font-weight-bolder text-primary text-gradient">Ingresar sueldo</h3>
                                                    <!--<p class="mb-0">Ingresar datos</p>-->
                                                </div>
                                                <div class="card-body pb-3">
                                                    <form role="form text-left" action="../ADM_Asignar_Sueldo">

                                                        <div> 

                                                            <label>Ejecutivo seleccionado</label>
                                                            <div class="input-group mb-3">
                                                                <input type="text" class="form-control" id="nombreEjecutivo" readonly>
                                                            </div>
                                                            <div class="input-group mb-3">
                                                                <input type="hidden" class="form-control" placeholder="" aria-label="Password" aria-describedby="password-addon" id="idEjecutivo" name ="idEjecutivo" required="true">
                                                            </div>

                                                            <label>Sueldo</label>

                                                            <div class="input-group mb-3">
                                                                <input type="number" class="form-control" placeholder="" aria-label="Password" aria-describedby="password-addon" id="sueldo" name ="sueldo" required="true">
                                                            </div>
                            ...
                            <div class="card-body px-0 pt-0 pb-2">
                                <div class="table-responsive p-0">
                                    ...
                                    String TDO = "SELECT a.idusuario , a.nombre, a.apellidos, a.sueldo, b.departamento , a.email FROM USUARIO A, ADM_DEPARTAMENTO B WHERE a.id_adm_departamento = b.id_departamento AND B.departamento IN ('MARKETING', 'TECNOLOGÍA', 'IMPUESTOS', 'ADMINISTRACIÓN', 'CONTABILIDAD') and sueldo > 0 AND A.estado = 'a'" ;           
                                    //            String sqlAtrasos1 = "SELECT a.idusuario , a.nombre, a.apellidos, a.sueldo, b.departamento, a.email FROM USUARIO A, ADM_DEPARTAMENTO B WHERE a.id_adm_departamento = b.id_departamento AND B.departamento IN ('MARKETING', 'TECNOLOGÍA', 'IMPUESTOS', 'ADMINISTRACIÓN', 'CONTABILIDAD') and sueldo > 0 AND A.estado = 'a'";
        ...
        <script>
            const exampleModal = document.getElementById('exampleModalSignUp2');

            exampleModal.addEventListener('show.bs.modal', event => {
                // Botón que disparó el modal
                const button = event.relatedTarget;

                // Extraer la información de los atributos data-id
                const recipientId = button.getAttribute('data-id');
                const nombre = button.getAttribute('data-nombre');
                const apellido = button.getAttribute('data-apellido');

                // Actualizar el contenido del input en el modal
                const modalBodyInput = exampleModal.querySelector('#idEjecutivo');
                const inputNombre = exampleModal.querySelector('#nombreEjecutivo');
