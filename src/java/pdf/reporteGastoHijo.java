 ...
 * @author Backup
 */
@WebServlet(name = "reporteGastoHijo", urlPatterns = {"/reporteGastoHijo"})
public class reporteGastoHijo extends HttpServlet {
    ...
    String logotipo ="";
     ...
     if (idCompa.equals("1")){
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet reporteGastoHijo</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println(" <img src=\"image/"+logotipo+".png\" alt=\"Esta es una descripcion alternativa de la imagen para cuando no se pueda mostrar\"   width=\"170\" height=\"90\" align=\"right\"/> ");
