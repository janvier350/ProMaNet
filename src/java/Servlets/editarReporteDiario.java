 ...
 * @author Backup
 */
@WebServlet(name = "editarReporteDiario", urlPatterns = {"/editarReporteDiario"})
public class editarReporteDiario extends HttpServlet {
...
//                 String idCab = request.getParameter(" idCab");
               ...
               System. out. println (idCab);
                ...
                double sumaAt = Double.valueOf(alimentacion) + Double.valueOf(transporte);
                
                String sql = "update REP_GASDET set idcliente = "+idCliente+"  , fecha = to_date('"+fecha+"','yyyy/mm/dd'),valor = "+sumaAt+", TRABREALIZADO = '"+trabajo+"', TOTALIM = "+alimentacion+", totmovi = "+transporte+"  WHERE IDREPGASCAB = "+idCab+" and IDREPGASDET ="+idDet+"";
        try{
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet editarReporteDiario</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<p>"+sql+" </p>");
//            out.println("<p>"+sql2+" </p>");
            out.println("<p>"+suma2+" </p>");
            out.println("<h1>Servlet editarReporteDiario at " + request.getContextPath() + "</h1>");
            out.println("</body>");
