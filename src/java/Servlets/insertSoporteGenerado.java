 ...
 * @author Backup
 */
@WebServlet(name = "insertSoporteGenerado", urlPatterns = {"/insertSoporteGenerado"})
public class insertSoporteGenerado extends HttpServlet {
...
//        insertar SOPORTE
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet insertSoporte</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet insertSoporte at " + request.getContextPath() + "</h1>");
